...
//        assertEquals("2017-04-17", json.getString("bookingdates.checkout"));
        ...
        softAssert.assertTrue(json.getString("lastname").equals("Jackson"),"Last name did not match");
        ...
        softAssert.assertEquals(json.getString("bookingdates.checkout"),"2018-02-16","Check out date did not match");
